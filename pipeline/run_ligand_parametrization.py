import json
from config_pipeline import input_dict, basepath, username, password, strucpath, parametrization
...
with open(f"{strucpath}/modresdict.json", "w") as modres_file:
    json.dump(modresdict, modres_file)

with open(f"{strucpath}/ligandsdict.json", "w") as ligands_file:
